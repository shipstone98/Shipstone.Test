...
{
    public static void AssertEmpty<T>(this IReadOnlyPaginatedList<T> list)
    {
        IReadOnlyList<T> source = Array.Empty<T>();
        Publics.AssertEqual(list, source, 0, 0, 1);
    }
    ...
    public static int[] CreateInt32Array(int length, int start = 1)
    {
